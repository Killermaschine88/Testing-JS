...
if(net.status != 200) {
      ...
      return
              ...
              let total = Math.floor(nw.purse.total) + Math.floor(nw.banking.total) + Math.floor(nw.inventory.total) + Math.floor(nw.accessories.total) + Math.floor(nw.ender_chest.total) + Math.floor(nw.armor.total) + Math.floor(nw.wardrobe.total) + Math.floor(nw.vault.total) + Math.floor(nw.storage.total) + Math.floor(nw.pets.total)
    ...
    if(armor.prices.length == 0) {
      ...
      armortext += armor.prices[i].item.name + ` ${recomb}` + ` **(${num(armor.prices[i].total)})**` + '\n'
        i += 1
      } else {
    ...
    if(wardrobe.prices.length == 0) {
      ...
      wardrobetext += wardrobe.prices[i].item.name + ` ${recomb}` + ` **(${num(wardrobe.prices[i].total)})**` + '\n'
        i += 1
      } else {
    ...
    if(inventory.prices.length == 0) {
      ...
      inventorytext += inventory.prices[i].item.name + ` ${recomb}` + ` **(${num(inventory.prices[i].total)})**` + '\n'
        i += 1
      } else {
    ...
    if(storage.prices.length == 0) {
      ...
      storagetext += storage.prices[i].item.name + ` ${recomb}` + ` **(${num(storage.prices[i].total)})**` + '\n'
        i += 1
      } else {
    ...
    if(pets.prices.length == 0) {
      ...
      petstext += pets.prices[i].item.tier + ' ' +pets.prices[i].item.type + ` ${recomb}` + ` **(${num(pets.prices[i].total)})**` + '\n'
        i += 1
      } else {
          petstext += pets.prices[i].item.tier + ' ' + pets.prices[i].item.type + ` **(${num(pets.prices[i].total)})**` + '\n'
          i += 1
      }
      }
      i = 0
    ...
    if(talis.prices.length == 0) {
      ...
      talistext += talis.prices[i].item.name + ` ${recomb}` + ` **(${num(talis.prices[i].total)})**` + '\n'
        i += 1
      } else {
