...
module.exports = {
  ...
  async execute(interaction, mclient) {
    ...
    embed.addField('Skills', `<:mining:852069714577719306> Mining: ${miningxp}%\n<:combat:852069714527911956> Combat: ${combatxp}%\n<:fishing:852069714359877643> Fishing: ${fishingxp}%`, true)
    ...
    embed.addField('Dungeons', `<:catacombs:854399510951624775> Dungeons: ${cataxp}%\n<:combat:852069714527911956> Assassin: ${assassinxp}%\n<:berserker:852079613052059658> Berserker: ${berserkerxp}%\n<:tank:852079613051666472> Tank: ${tankxp}%`, true)
