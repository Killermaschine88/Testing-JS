    ...
    if(type == 'sword') {
      item = sword[number]
        ...
        await collection.updateOne(
          ...
          { $set: { "data.equipment.combat.sword.name": item.name, "data.equipment.combat.sword.damage": item.damage, "data.equipment.combat.sword.strength": item.strength, "data.equipment.combat.sword.crit_chance": item.crit_chance, "data.equipment.combat.sword.crit_damage": item.crit_damage, "data.equipment.combat.sword.recombobulated": item.recombobulated, "data.equipment.combat.sword.reforge": item.reforge }},
          { upsert: true })
